...
# Inicializar y entrenar PoissonRegressor para goles del equipo local
reg_local = PoissonRegressor(**params)
...
# Inicializar y entrenar PoissonRegressor para goles del equipo visitante
reg_visitante = PoissonRegressor(**params)
...
mlflow.set_experiment("PoissonRegressor_Futbol")
...
with mlflow.start_run():
    ...
    # Set tags
    mlflow.set_tag("model_type", "PoissonRegressor")
    ...
    mlflow.sklearn.log_model(
        ...
        registered_model_name="PoissonRegressor_Futbol_Local"
    )
    mlflow.sklearn.log_model(
        ...
        signature=signature,
        input_example=X_train.iloc[0].to_dict(),
        registered_model_name="PoissonRegressor_Futbol_Visitante"
    )
