...
# Inicializar y entrenar LinearRegression para goles del equipo local
reg_local = LinearRegression(**params)
...
# Inicializar y entrenar LinearRegression para goles del equipo visitante
reg_visitante = LinearRegression(**params)
...
mlflow.set_experiment("LinearRegression_Futbol")
...
with mlflow.start_run():
    ...
    mlflow.sklearn.log_model(
        ...
        registered_model_name="LinearRegression_Futbol_Local"
    )
    mlflow.sklearn.log_model(
        ...
        signature=signature,
        input_example=X_train.iloc[0].to_dict(),
        registered_model_name="LinearRegression_Futbol_Visitante"
    ) 