...
# Inicializar y entrenar RandomForestRegressor para goles del equipo local
reg_local = RandomForestRegressor(**params)
...
# Inicializar y entrenar RandomForestRegressor para goles del equipo visitante
reg_visitante = RandomForestRegressor(**params)
...
mlflow.set_experiment("RandomForestRegressor_Futbol")
...
with mlflow.start_run():
    ...
    mlflow.sklearn.log_model(
        ...
        registered_model_name="RandomForestRegressor_Futbol_Local"
    )
    mlflow.sklearn.log_model(
        ...
        signature=signature,
        input_example=X_train.iloc[0].to_dict(),
        registered_model_name="RandomForestRegressor_Futbol_Visitante"
    ) 